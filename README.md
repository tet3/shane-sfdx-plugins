...
shane-sfdx-plugins/0.16.1 darwin-x64 node-v9.11.1
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src/commands/shane/user/photo.ts](https://github.com/mshanemc/shane-sfdx-plugins/blob/v0.16.1/src/commands/shane/user/photo.ts)_
<!-- commandsstop -->
